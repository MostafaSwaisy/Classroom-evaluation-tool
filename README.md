...
بالإضافة لسطر الأوامر، في واجهة مكتبية (PySide6) عربية RTL بالكامل — نفس الـ pipeline
بشكل تفاعلي بدل الأوامر.

```bash
python run_gui.py
```

الشاشات: الرئيسية، المساقات، الواجبات، السحب، التحضير، الكشف، التصحيح، مسودة الدرجات،
محرر المعايير، تقرير المتابعة، الإعدادات، والاتصالات والفحص. كل شاشة بتنده نفس منطق
`classroom_tool/` تبع سطر الأوامر — الواجهة غلاف بس، مافي منطق مكرر.
